...
class EducationModel(models.Model):
    ...
    def save(self, **kwargs):
        if kwargs.__contains__('request') and self.user in None:
...
class ProjectModel(models.Model):
    ...
    def get_project_absolute_irl(self):
...
class MessageModel(models.Model):
    ...
    def save(self, **kwagrs):
        if kwagrs.__contains__('request')  and self.user is None:
            request = kwagrs.pop('request')
            self.user = request.user
        super(MessageModel, self).save(**kwagrs)
